...
#
package Net::Sms::TextMagicClient::Object::CreateSurveyNodeInputObject;
...
__PACKAGE__->method_documentation({
    ...
    'send_delay' => {
    	datatype => 'int',
    	base_name => 'sendDelay',
    	description => 'Define delay for sending question to recipients after previous answer. Default is 0',
    	format => '',
    	read_only => '',
    		},
});
