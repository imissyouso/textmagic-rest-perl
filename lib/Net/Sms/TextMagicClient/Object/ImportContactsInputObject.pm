...
#
package Net::Sms::TextMagicClient::Object::ImportContactsInputObject;
...
__PACKAGE__->method_documentation({
    'column' => {
    	datatype => 'ARRAY[ImportColumnMappingItem]',
    	base_name => 'column',
    	description => 'Column values mapping (number column &#x3D;&gt; field), e.g. column[0] &#x3D; \&quot;phone\&quot;, column[1] &#x3D; \&quot;firstName\&quot;',
    	format => '',
    	read_only => '',
    		},
    'list_name' => {
...
__PACKAGE__->swagger_types( {
    'column' => 'ARRAY[ImportColumnMappingItem]',
    'list_name' => 'string',
    'list_id' => 'string'
} );
