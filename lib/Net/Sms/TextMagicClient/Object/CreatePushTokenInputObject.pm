...
#
package Net::Sms::TextMagicClient::Object::CreatePushTokenInputObject;
...
__PACKAGE__->method_documentation({
    ...
    'push_service_type' => {
    	...
    	description => 'Push notification service type: a for Apple Push Notifications, g for Google Cloud Messaging',
    	format => '',
    	read_only => '',
    		},
});
