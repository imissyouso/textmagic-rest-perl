...
__PACKAGE__->method_documentation({
    ...
    'favorited' => {
    	datatype => 'boolean',
    	base_name => 'favorited',
    	description => 'Is contact marked as favorite.',
    	format => '',
    	read_only => '',
    		},
    'blocked' => {
    ...
    'type' => {
    	datatype => 'int',
    	base_name => 'type',
    	description => 'Force type of phone. Possible values: 0 - landline, 1 - mobile. Default is -1 (auto detection).',
    	format => '',
    	read_only => '',
    		},
    'custom_field_values' => {
    ...
    'country' => {
    	datatype => 'string',
    	base_name => 'country',
    	description => '2-letter ISO country code for local phone numbers, used when **local** is set to true.',
    	format => '',
    	read_only => '',
    		},
});
