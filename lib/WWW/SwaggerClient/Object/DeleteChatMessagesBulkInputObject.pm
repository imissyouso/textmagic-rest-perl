...
#
package WWW::SwaggerClient::Object::DeleteChatMessagesBulkInputObject;
...
__PACKAGE__->method_documentation({
    'inbound_ids' => {
    	...
    	description => 'Inbound messages ID(s) to delete. Require when \&quot;all\&quot; equal to 0 (false).',
    	format => '',
    	read_only => '',
    		},
    'sent_ids' => {
    	datatype => 'string',
    	base_name => 'sent_ids',
    	description => 'Sent messages ID(s) to delete. Require when \&quot;all\&quot; equal to 0 (false).',
    	format => '',
    	read_only => '',
    		},
    'calls_ids' => {
