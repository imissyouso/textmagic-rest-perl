...
#
package WWW::SwaggerClient::Object::MessageOut;
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
    	datatype => 'string',
    	base_name => 'status',
    	description => 'q - queued s - scheduled queue e - sending error r - enroute a - acked d - delivered b - buffered f - failed u - unknown j - rejected i - bulk insert p - scheduled suspend h - queue suspend',
    	format => '',
    	read_only => '',
    		},
    'avatar' => {
